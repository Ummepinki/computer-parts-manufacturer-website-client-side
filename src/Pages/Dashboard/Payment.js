...
const stripePromise = loadStripe(
  "pk_test_51LEwZgF9XkD0LJbNlNAE8fElddBb1euv1PlC8N7zzhNnLUEenSZaRozwGFf3L1Vras1h6rReWmYJjDa4O0c99JGD00OuNzk9jw"
);
const Payment = () => {
  const { id } = useParams();
  const url = `https://manufacturer-website-server-side-topaz.vercel.app/booking/${id}`;
